...
class Pregunta(models.Model):
    ...
    NUM_DE_RESPUESTAS_PERMITIDAS = 2
    texto = models.TextField(verbose_name='Texto de la pregunta')
    max_puntaje= models.DecimalField(verbose_name='Maximo Puntaje', default= 20, decimal_places=1, max_digits=6)
...
class QuizUsuario(models.Model):
    ...
    def validar_intento(self, pregunta_respondida, respuesta_selecionada):
        ...
        def actualizar_puntaje(self):
            puntaje_actualizado =  self.intentos.filter(correcta = True)
